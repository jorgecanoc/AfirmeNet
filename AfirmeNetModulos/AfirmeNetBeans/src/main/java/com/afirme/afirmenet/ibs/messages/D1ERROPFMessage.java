...
public class D1ERROPFMessage extends MessageRecord {
	...
	final static String tnames[] = { "ERRNUM", "ERNU01", "ERNU02", "ERNU03",
			...
			"ERDR10", "ERWRNG", "ERWF01", "ERWF02", "ERWF03", "ERWF04",
			"ERWF05", "ERWF06", "ERWF07", "ERWF08", "ERWF09", "ERWF10" };
	final static String fid = "1130524171345";
	final static String rid = "2F9ED8A87DFD7";
	final static String fmtname = "D1ERROPF";
	...
	/**
	 * Constructor for D1ERROPFMessage.
	 */
	public D1ERROPFMessage() {
		createFields();
		initialize();
	}
