...
/**
 * Class generated by AS/400 CRTCLASS command from SPMERRPF physical file
 * definition.
 * 
 * File level identifier is 1141007165106. Record format level identifier is
 * 2FD0B7096CBD7.
 */
@SuppressWarnings("rawtypes")
public class SPMERRPFMessage extends MessageRecord {
	...
	final static String tnames[] = { "ERRNUM", "ERNU01", "ERNU02", "ERNU03",
			...
			"ERDR10", "ERWRNG", "ERWF01", "ERWF02", "ERWF03", "ERWF04",
			"ERWF05", "ERWF06", "ERWF07", "ERWF08", "ERWF09", "ERWF10" };
	final static String fid = "1141007165106";
	final static String rid = "2FD0B7096CBD7";
	final static String fmtname = "SPMERRPF";
	...
	/**
	 * Constructor for SPMERRPFMessage.
	 */
	public SPMERRPFMessage() {
		createFields();
		initialize();
	}
