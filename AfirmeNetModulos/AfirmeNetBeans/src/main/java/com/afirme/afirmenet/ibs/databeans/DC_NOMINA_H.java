 ...
 * Jdbc Bean Class<br>
 * <br>
 * Autogenerated on 02/04/2004 12:20:13<br>
 * &nbsp;&nbsp;&nbsp; table = "DC_NOMINA_HBean"
 * 
 * @author Generator
 */
public class DC_NOMINA_H implements java.io.Serializable {
	 ...
	 */
	protected java.math.BigDecimal TLIMIT = new BigDecimal("0");

	/**
	 * Gets the TLIMIT value.
	 */
	public java.math.BigDecimal getTLIMIT() {
		return TLIMIT;
	}
	 ...
	 */
	public void setTLIMIT(java.math.BigDecimal TLIMIT) {
		this.TLIMIT = TLIMIT;
	}
