...
/**
 * Class generated by AS/400 CRTCLASS command from ELEERR physical file
 * definition.
 * 
 * File level identifier is 1011023135721. Record format level identifier is
 * 44FFC5E87DFD5.
 */
...
public class ELEERRMessage extends MessageRecord {
	...
	final static String tnames[] = { "ERRNUM", "ERNU01", "ERNU02", "ERNU03",
			...
			"ERDR10", "ERWRNG", "ERWF01", "ERWF02", "ERWF03", "ERWF04",
			"ERWF05", "ERWF06", "ERWF07", "ERWF08", "ERWF09", "ERWF10" };
	final static String fid = "1011023135721";
