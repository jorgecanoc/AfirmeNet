...
/**
 * Class generated by AS/400 CRTCLASS command from INLOGIN02 physical file
 * definition.
 * 
 * File level identifier is 1131018132237. Record format level identifier is
 * 419F2969B71BA.
 */
@SuppressWarnings("rawtypes")
public class INLOGIN02Message extends MessageRecord {
...
final static String fid = "1150218122728";
final static String rid = "43831CC3954CE";
final static String fmtname = "INLOGIN02";
...
private CharacterField fieldPWDDIP = null;
private CharacterField fieldPWDBRW = null;

/**
* Constructor for INLOGIN02Message.
*/
public INLOGIN02Message()
{
createFields();
initialize();
}
...
fields[0] = fieldPWDUSR =
new CharacterField(message, HEADERSIZE + 0, 10, "PWDUSR");
fields[1] = fieldPWDPWD =
new CharacterField(message, HEADERSIZE + 10, 10, "PWDPWD");
fields[2] = fieldPWDNPW =
new CharacterField(message, HEADERSIZE + 20, 10, "PWDNPW");
fields[3] = fieldPWDCPW =
new CharacterField(message, HEADERSIZE + 30, 10, "PWDCPW");
fields[4] = fieldPWDGRP =
new CharacterField(message, HEADERSIZE + 40, 4, "PWDGRP");
fields[5] = fieldPWDNCH =
new CharacterField(message, HEADERSIZE + 44, 2, "PWDNCH");
fields[6] = fieldPWDSTS =
new CharacterField(message, HEADERSIZE + 46, 1, "PWDSTS");
fields[7] = fieldPWDOPR =
new CharacterField(message, HEADERSIZE + 47, 1, "PWDOPR");
fields[8] = fieldPWDCFM =
new CharacterField(message, HEADERSIZE + 48, 1, "PWDCFM");
fields[9] = fieldPWDTRA =
new CharacterField(message, HEADERSIZE + 49, 1, "PWDTRA");
fields[10] = fieldPWDBPA =
new CharacterField(message, HEADERSIZE + 50, 1, "PWDBPA");
fields[11] = fieldPWDLCA =
new CharacterField(message, HEADERSIZE + 51, 1, "PWDLCA");
fields[12] = fieldPWDLNP =
new CharacterField(message, HEADERSIZE + 52, 1, "PWDLNP");
fields[13] = fieldPWDCCP =
new CharacterField(message, HEADERSIZE + 53, 1, "PWDCCP");
fields[14] = fieldPWDMAX =
new DecimalField(message, HEADERSIZE + 54, 15, 2, "PWDMAX");
fields[15] = fieldPWDDTF =
new CharacterField(message, HEADERSIZE + 69, 1, "PWDDTF");
fields[16] = fieldPWDLGT =
new CharacterField(message, HEADERSIZE + 70, 1, "PWDLGT");
fields[17] = fieldPWDACL =
new CharacterField(message, HEADERSIZE + 71, 2, "PWDACL");
fields[18] = fieldPWDCMP =
new CharacterField(message, HEADERSIZE + 73, 10, "PWDCMP");
fields[19] = fieldPWDINC =
new CharacterField(message, HEADERSIZE + 83, 4, "PWDINC");
fields[20] = fieldPWDBUC =
new CharacterField(message, HEADERSIZE + 87, 4, "PWDBUC");
fields[21] = fieldPWDGEC =
new CharacterField(message, HEADERSIZE + 91, 4, "PWDGEC");
fields[22] = fieldPWDIAD =
new CharacterField(message, HEADERSIZE + 95, 60, "PWDIAD");
fields[23] = fieldPWDFAC =
new CharacterField(message, HEADERSIZE + 155, 1, "PWDFAC");
fields[24] = fieldPWDKID =
new CharacterField(message, HEADERSIZE + 156, 10, "PWDKID");
fields[25] = fieldPWDEST =
new CharacterField(message, HEADERSIZE + 166, 1, "PWDEST");
fields[26] = fieldPWDPAT =
new CharacterField(message, HEADERSIZE + 167, 1, "PWDPAT");
fields[27] = fieldPWDCUN =
new DecimalField(message, HEADERSIZE + 168, 10, 0, "PWDCUN");
fields[28] = fieldPWDNME =
new CharacterField(message, HEADERSIZE + 178, 80, "PWDNME");
fields[29] = fieldPWDSUC =
new CharacterField(message, HEADERSIZE + 258, 4, "PWDSUC");
fields[30] = fieldPWDALIAS =
new CharacterField(message, HEADERSIZE + 262, 30, "PWDALIAS");
fields[31] = fieldPWDOFC =
new CharacterField(message, HEADERSIZE + 292, 35, "PWDOFC");
fields[32] = fieldPWDEML =
new CharacterField(message, HEADERSIZE + 327, 40, "PWDEML");
fields[33] = fieldPWDDIP =
new CharacterField(message, HEADERSIZE + 367, 15, "PWDDIP");
fields[34] = fieldPWDBRW =
new CharacterField(message, HEADERSIZE + 382, 35, "PWDBRW");
...
/**
* Set field PWDDIP using a String value.
*/
public void setPWDDIP(String newvalue)
{
fieldPWDDIP.setString(newvalue);
}

/**
* Get value of field PWDDIP as a String.
*/
public String getPWDDIP()
{
return fieldPWDDIP.getString();
}

/**
* Set field PWDBRW using a String value.
*/
public void setPWDBRW(String newvalue)
{
fieldPWDBRW.setString(newvalue);
}

/**
* Get value of field PWDBRW as a String.
*/
public String getPWDBRW()
{
return fieldPWDBRW.getString();
}
