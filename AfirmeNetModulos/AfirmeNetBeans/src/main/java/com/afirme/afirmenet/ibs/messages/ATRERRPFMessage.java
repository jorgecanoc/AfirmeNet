...
/**
 * Class generated by AS/400 CRTCLASS command from ATRERRPF physical file
 * definition.
 * 
 * File level identifier is 1140606133729. Record format level identifier is
 * 2FCEA7C9BCBD7.
 */
@SuppressWarnings("rawtypes")
public class ATRERRPFMessage extends MessageRecord {
	...
	final static String tnames[] = { "ERRNUM", "ERNU01", "ERNU02", "ERNU03",
			...
			"ERDR10", "ERWRNG", "ERWF01", "ERWF02", "ERWF03", "ERWF04",
			"ERWF05", "ERWF06", "ERWF07", "ERWF08", "ERWF09", "ERWF10" };
	final static String fid = "1140606133729";
	final static String rid = "2FCEA7C9BCBD7";
	final static String fmtname = "ATRERRPF";
	...
	/**
	 * Constructor for ATRERRPFMessage.
	 */
	public ATRERRPFMessage() {
		createFields();
		initialize();
	}
