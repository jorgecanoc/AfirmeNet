...
/**
 * Class generated by AS/400 CRTCLASS command from EDD0395DS physical file
 * definition.
 * 
 * File level identifier is 1030723105323. Record format level identifier is
 * 563E131AAECBD.
 */
...
public class EDD0395DSMessage extends MessageRecord {
	final static String fldnames[] = { "H01USERID", "H01PROGRM", "H01TIMSYS",
			...
			"H01FLGWK3", "E01UNCACC", "E01UNCFLG", "E01UNCAMN", "E01UNCCKN",
			"E01UNCDYS", "E01UNCRD1", "E01UNCRD2", "E01UNCRD3", "E01UNCMD1",
			"E01UNCMD2", "E01UNCMD3", "E01UNCRSN", "E01UNCCUN", "E01UNCSTA",
			"E01UNCCON", "E01UNCTEL", "E01UNCTSQ", "E01UNCKBK", "E01UNCKBR",
			"E01UNCKAC", "E01UNCDES", "E01UNCCRM", "E01UNCOBR", "E01UNCHTY",
			"E01UNCNRM", "E01UNCUSR", "E01UNCFUS", "E01UNCF02" };
	final static String tnames[] = { "H01USERID", "H01PROGRM", "H01TIMSYS",
			...
			"E01UNCKAC", "E01UNCDES", "E01UNCCRM", "E01UNCOBR", "E01UNCHTY",
			"E01UNCNRM", "E01UNCUSR", "E01UNCFUS", "E01UNCF02" };
	final static String fid = "1030723105323";
	...
	protected void createFields() {
		...
		fields[9] = fieldE01UNCACC = new DecimalField(message, HEADERSIZE + 42,
				13, 0, "E01UNCACC");
		fields[10] = fieldE01UNCFLG = new CharacterField(message,
				HEADERSIZE + 55, 1, "E01UNCFLG");
		fields[11] = fieldE01UNCAMN = new DecimalField(message,
				HEADERSIZE + 56, 17, 2, "E01UNCAMN");
		fields[12] = fieldE01UNCCKN = new DecimalField(message,
				HEADERSIZE + 73, 10, 0, "E01UNCCKN");
		fields[13] = fieldE01UNCDYS = new DecimalField(message,
				HEADERSIZE + 83, 5, 0, "E01UNCDYS");
		fields[14] = fieldE01UNCRD1 = new DecimalField(message,
				HEADERSIZE + 88, 3, 0, "E01UNCRD1");
		fields[15] = fieldE01UNCRD2 = new DecimalField(message,
				HEADERSIZE + 91, 3, 0, "E01UNCRD2");
		fields[16] = fieldE01UNCRD3 = new DecimalField(message,
				HEADERSIZE + 94, 3, 0, "E01UNCRD3");
		fields[17] = fieldE01UNCMD1 = new DecimalField(message,
				HEADERSIZE + 97, 3, 0, "E01UNCMD1");
		fields[18] = fieldE01UNCMD2 = new DecimalField(message,
				HEADERSIZE + 100, 3, 0, "E01UNCMD2");
		fields[19] = fieldE01UNCMD3 = new DecimalField(message,
				HEADERSIZE + 103, 3, 0, "E01UNCMD3");
		fields[20] = fieldE01UNCRSN = new CharacterField(message,
				HEADERSIZE + 106, 15, "E01UNCRSN");
		fields[21] = fieldE01UNCCUN = new DecimalField(message,
				HEADERSIZE + 121, 10, 0, "E01UNCCUN");
		fields[22] = fieldE01UNCSTA = new CharacterField(message,
				HEADERSIZE + 131, 1, "E01UNCSTA");
		fields[23] = fieldE01UNCCON = new CharacterField(message,
				HEADERSIZE + 132, 4, "E01UNCCON");
		fields[24] = fieldE01UNCTEL = new CharacterField(message,
				HEADERSIZE + 136, 7, "E01UNCTEL");
		fields[25] = fieldE01UNCTSQ = new DecimalField(message,
				HEADERSIZE + 143, 6, 0, "E01UNCTSQ");
		fields[26] = fieldE01UNCKBK = new CharacterField(message,
				HEADERSIZE + 149, 4, "E01UNCKBK");
		fields[27] = fieldE01UNCKBR = new CharacterField(message,
				HEADERSIZE + 153, 4, "E01UNCKBR");
		fields[28] = fieldE01UNCKAC = new CharacterField(message,
				HEADERSIZE + 157, 15, "E01UNCKAC");
		fields[29] = fieldE01UNCDES = new CharacterField(message,
				HEADERSIZE + 172, 5, "E01UNCDES");
		fields[30] = fieldE01UNCCRM = new CharacterField(message,
				HEADERSIZE + 177, 3, "E01UNCCRM");
		fields[31] = fieldE01UNCOBR = new DecimalField(message,
				HEADERSIZE + 180, 4, 0, "E01UNCOBR");
		fields[32] = fieldE01UNCHTY = new CharacterField(message,
				HEADERSIZE + 184, 4, "E01UNCHTY");
		fields[33] = fieldE01UNCNRM = new DecimalField(message,
				HEADERSIZE + 188, 13, 0, "E01UNCNRM");
		fields[34] = fieldE01UNCUSR = new CharacterField(message,
				HEADERSIZE + 201, 4, "E01UNCUSR");
		fields[35] = fieldE01UNCFUS = new CharacterField(message,
				HEADERSIZE + 205, 1, "E01UNCFUS");
		fields[36] = fieldE01UNCF02 = new CharacterField(message,
				HEADERSIZE + 206, 1, "E01UNCF02");
