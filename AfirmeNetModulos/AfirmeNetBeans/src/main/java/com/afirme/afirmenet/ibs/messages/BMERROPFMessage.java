...
/**
 * Class generated by AS/400 CRTCLASS command from BMERROPF physical file
 * definition.
 * 
 * File level identifier is 1111123173616. Record format level identifier is
 * 2F9EB6D87DFD7.
 */
@SuppressWarnings("rawtypes")
public class BMERROPFMessage extends MessageRecord {
	...
	final static String tnames[] = { "ERRNUM", "ERNU01", "ERNU02", "ERNU03",
			...
			"ERDR10", "ERWRNG", "ERWF01", "ERWF02", "ERWF03", "ERWF04",
			"ERWF05", "ERWF06", "ERWF07", "ERWF08", "ERWF09", "ERWF10" };
	final static String fid = "1111123173616";
	final static String rid = "2F9EB6D87DFD7";
	final static String fmtname = "BMERROPF";
	...
	/**
	 * Constructor for BMERROPFMessage.
	 */
	public BMERROPFMessage() {
		createFields();
		initialize();
	}
