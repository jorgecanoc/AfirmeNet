 ...
 *
 */
public class DC_SWIFTTRANS implements Serializable {
	static final Logger LOG = LoggerFactory
			.getLogger(DC_SWIFTTRANS.class);
	/**
	 * 
	 */
	...
	public boolean updateSwiftRecordData(DC_SWIFTTRANS swiftbean)
	{
		...
		try {
			...
			String STMT = "" +
				"UPDATE DC_SWIFTTRANS " +
				" SET " +				" AMTINCCY = ?," +
				" INSTRUCCIONES1 = ?,	INSTRUCCIONES2 = ?, " +
				" DESCRIP1  = ?, DESCRIP2 = ?, " +
				" VYY  = ?, VMM = ?,  VDD= ?, " +				" VHH  = ?, VSS = ? " +
				" WHERE " +
				" ENTITYID = ? AND USERID = ? AND DCIBS_REF = ?";
			...
			st.setString	(13,swiftbean.getDCIBS_REF().trim());
	...
	public boolean createSwiftRecord()
	{
		...
		try {
			...
			st.setString	(3, getDEBACC());
			st.setString	(4, getCREACC());
			st.setString	(5, getCCY());
			st.setString	(6, getCCYCONV());
			st.setBigDecimal(7, getAMTINCCY());
			st.setBigDecimal(8, getEXRATE());
			st.setBigDecimal(9, getAMOUNT());
			st.setString	(10,getINSTRUCCIONES1());
			st.setString	(11,getINSTRUCCIONES2());
			st.setString	(12,getBENENAME());
			st.setString	(13,getDESCRIP1());
			st.setString	(14,getDESCRIP2());
			st.setString	(15,getSWIFTNUM());
			st.setString	(16,getSWIFTNOM());
			st.setString	(17,getSWIFTARE());
			st.setString	(18,getSWIFTEDO());
			st.setString	(19,getSWIFTCD());
			st.setString	(20,getSWIFTPAI());
			st.setString	(21,getSWIFTFULL());
			st.setBigDecimal(22,getABANUM());
			st.setString	(23,getABANOM());
			st.setString	(24,getABACTY());
			st.setString	(25,getABAEDO());
			st.setString	(26,getVMM());
			st.setString	(27,getVDD());
			st.setString	(28,getVYY());
			st.setString	(29,getVHH());
			st.setString	(30,getVSS());
			st.setString	(31,getPMM());
			st.setString	(32,getPDD());
			st.setString	(33,getPYY());
			
			st.setString	(34,getOUSER());
			st.setString	(35,getVUSER());
			st.setString	(36,getAUSER());
			st.setString	(37,getODATE());
			st.setString	(38,getVDATE());
			st.setString	(39,getADATE());
			st.setBigDecimal(40,getNUMAPR());
			st.setString	(41,getDCIBS_REF());
			st.setString	(42,getSTS());
			st.setString	(43,getVIA());
			st.setString	(44,getBY_CODE());
			
			st.setString	(45,getPHH());
			st.setString	(46,getPSS());
...
//	public DC_SWIFTTRANS getSwiftTransfer(String ENTITYID, HttpSession session, String AccNumber) {
//
//			DC_SWIFTTRANS swiftbean = null;
//
//			Connection cnx = null;
//
//			try {
...
//				STM =
//					"SELECT * "
//						+ " from DC_SWIFTTRANS where ENTITYID = '"
//						+ ENTITYID
//						+ "' and DCIBS_REF='"
//						+ AccNumber //						+ "'"
...
//		}
//		
//	public boolean procUpdateConfNUM(String CONFNUM, String DCIBS_REF, String ENTITYID)
...
//	}	
//	
//	public boolean getSwiftTransferList(String ENTITYID, HttpSession session, JBUserAccSubList lstAccUserTransbean) {
//
//		DC_SWIFTTRANS swiftbean;
...
//	}
//	
//	public boolean deleteSwiftRecord(DC_SWIFTTRANS swiftbean) {
//
//		boolean ok = false;
//
//		Connection cnx = null;
...
//			cnx = ServiceLocator.getInstance().getDBConn("MSS");
//			String STM = 
//				"delete from DC_SWIFTTRANS where ENTITYID = ? AND USERID = ? AND DCIBS_REF = ?";
//
//			PreparedStatement st = cnx.prepareStatement(STM);
//			
//			st.setString(1,swiftbean.getENTITYID());
//			st.setString(2,swiftbean.getUSERID());
//			st.setString(3, swiftbean.getDCIBS_REF());
//			
//			ok = st.executeUpdate() == 0;
//			
//			cnx.close();
