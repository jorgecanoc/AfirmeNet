...
/**
 * Class generated by AS/400 CRTCLASS command from ILN006001 physical file
 * definition.
 * 
 * File level identifier is 1030828135655. Record format level identifier is
 * 5CEC04DB7C9DF.
 */
@SuppressWarnings("rawtypes")
public class ILN006001Message extends MessageRecord {
	final static String fldnames[] = { "LN61USER", "LN61TYPE", "LN61LNECUN",
			"LN61LNENUM", "LN61LNETYL", "LN61LNECCY", "LN61LNEAMN",
			"LN61LNEREA", "LN61LNEAMU", "LN61LNEOFA", "LN61COLAMT",
			"LN61LNEOCM", "LN61LNERE1", "LN61LNERE2", "LN61LNERE3",
			"LN61LNEPUR", "LN61LNEOP1", "LN61LNEOP2", "LN61LNEOP3",
			"LN61LNEMT1", "LN61LNEMT2", "LN61LNEMT3", "LN61AVAILA", "LN61RATE" };
	final static String tnames[] = { "LN61USER", "LN61TYPE", "LN61LNECUN",
			"LN61LNENUM", "LN61LNETYL", "LN61LNECCY", "LN61LNEAMN",
			"LN61LNEREA", "LN61LNEAMU", "LN61LNEOFA", "LN61COLAMT",
			"LN61LNEOCM", "LN61LNERE1", "LN61LNERE2", "LN61LNERE3",
			"LN61LNEPUR", "LN61LNEOP1", "LN61LNEOP2", "LN61LNEOP3",
			"LN61LNEMT1", "LN61LNEMT2", "LN61LNEMT3", "LN61AVAILA", "LN61RATE" };
	final static String fid = "1030828135655";
	final static String rid = "5CEC04DB7C9DF";
	...
	protected void createFields() {
		...
		fields[0] = fieldLN61USER = new CharacterField(message, HEADERSIZE + 0,
				10, "LN61USER");
		fields[1] = fieldLN61TYPE = new CharacterField(message,
				HEADERSIZE + 10, 4, "LN61TYPE");
		fields[2] = fieldLN61LNECUN = new DecimalField(message,
				HEADERSIZE + 14, 10, 0, "LN61LNECUN");
		fields[3] = fieldLN61LNENUM = new DecimalField(message,
				HEADERSIZE + 24, 5, 0, "LN61LNENUM");
		fields[4] = fieldLN61LNETYL = new CharacterField(message,
				HEADERSIZE + 29, 4, "LN61LNETYL");
		fields[5] = fieldLN61LNECCY = new CharacterField(message,
				HEADERSIZE + 33, 3, "LN61LNECCY");
		fields[6] = fieldLN61LNEAMN = new DecimalField(message,
				HEADERSIZE + 36, 17, 2, "LN61LNEAMN");
		fields[7] = fieldLN61LNEREA = new DecimalField(message,
				HEADERSIZE + 53, 17, 2, "LN61LNEREA");
		fields[8] = fieldLN61LNEAMU = new DecimalField(message,
				HEADERSIZE + 70, 17, 2, "LN61LNEAMU");
		fields[9] = fieldLN61LNEOFA = new DecimalField(message,
				HEADERSIZE + 87, 17, 2, "LN61LNEOFA");
		fields[10] = fieldLN61COLAMT = new DecimalField(message,
				HEADERSIZE + 104, 17, 2, "LN61COLAMT");
		fields[11] = fieldLN61LNEOCM = new DecimalField(message,
				HEADERSIZE + 121, 17, 2, "LN61LNEOCM");
		fields[12] = fieldLN61LNERE1 = new DecimalField(message,
				HEADERSIZE + 138, 3, 0, "LN61LNERE1");
		fields[13] = fieldLN61LNERE2 = new DecimalField(message,
				HEADERSIZE + 141, 3, 0, "LN61LNERE2");
		fields[14] = fieldLN61LNERE3 = new DecimalField(message,
				HEADERSIZE + 144, 3, 0, "LN61LNERE3");
		fields[15] = fieldLN61LNEPUR = new CharacterField(message,
				HEADERSIZE + 147, 35, "LN61LNEPUR");
		fields[16] = fieldLN61LNEOP1 = new DecimalField(message,
				HEADERSIZE + 182, 3, 0, "LN61LNEOP1");
		fields[17] = fieldLN61LNEOP2 = new DecimalField(message,
				HEADERSIZE + 185, 3, 0, "LN61LNEOP2");
		fields[18] = fieldLN61LNEOP3 = new DecimalField(message,
				HEADERSIZE + 188, 3, 0, "LN61LNEOP3");
		fields[19] = fieldLN61LNEMT1 = new DecimalField(message,
				HEADERSIZE + 191, 3, 0, "LN61LNEMT1");
		fields[20] = fieldLN61LNEMT2 = new DecimalField(message,
				HEADERSIZE + 194, 3, 0, "LN61LNEMT2");
		fields[21] = fieldLN61LNEMT3 = new DecimalField(message,
				HEADERSIZE + 197, 3, 0, "LN61LNEMT3");
		fields[22] = fieldLN61AVAILA = new DecimalField(message,
				HEADERSIZE + 200, 17, 2, "LN61AVAILA");
		fields[23] = fieldLN61RATE = new DecimalField(message,
				HEADERSIZE + 217, 11, 6, "LN61RATE");
