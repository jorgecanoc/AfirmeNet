...
/**
 * Class generated by AS/400 CRTCLASS command from STMRDSJV physical file
 * definition.
 * 
 * File level identifier is 1030723105755. Record format level identifier is
 * 428723E1DBE71.
 */
@SuppressWarnings("rawtypes")
public class STMRDSJVMessage extends MessageRecord {
	...
	final static String tnames[] = { "RSTUSR", "RSTACC", "RSTCAF", "RSTFD1",
			"RSTFD2", "RSTFD3", "RSTTD1", "RSTTD2", "RSTTD3", "RSTFCK",
			"RSTTCK", "RSTFAM", "RSTTAM", "RSTFRC", "RSTFBL" };
	final static String fid = "1030723105755";
	final static String rid = "428723E1DBE71";
	final static String fmtname = "STMRDSJV";
	...
	/**
	 * Constructor for STMRDSJVMessage.
	 */
	public STMRDSJVMessage() {
		createFields();
		initialize();
	}
