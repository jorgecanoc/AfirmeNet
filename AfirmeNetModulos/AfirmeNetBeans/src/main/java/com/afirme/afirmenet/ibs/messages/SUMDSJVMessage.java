...
public class SUMDSJVMessage extends MessageRecord {
	...
	final static String tnames[] = { "SUMUSR", "SUMFLG", "SUMTYP", "SUMDSC",
			...
			"SUMCLA", "SUMODD", "SUMODM", "SUMODY", "SUMMAD", "SUMMAM",
			"SUMMAY", "SUMFCP" };
	final static String fid = "1120801163018";
	final static String rid = "5B9A51F87A44E";
	final static String fmtname = "SUMDSJV";
	...
	/**
	 * Constructor for SUMDSJVMessage.
	 */
	public SUMDSJVMessage() {
		createFields();
		initialize();
	}
	...
	protected void createFields() {
		...
		fields[2] = fieldSUMTYP = new CharacterField(message, HEADERSIZE + 13,
				3, "SUMTYP");
		fields[3] = fieldSUMDSC = new CharacterField(message, HEADERSIZE + 16,
				30, "SUMDSC");
		fields[4] = fieldSUMACN = new DecimalField(message, HEADERSIZE + 46,
				17, 0, "SUMACN");
		fields[5] = fieldSUMBAL = new DecimalField(message, HEADERSIZE + 63,
				17, 2, "SUMBAL");
		fields[6] = fieldSUMAVB = new DecimalField(message, HEADERSIZE + 80,
				17, 2, "SUMAVB");
		fields[7] = fieldSUMCCY = new CharacterField(message, HEADERSIZE + 97,
				3, "SUMCCY");
		fields[8] = fieldSUMNNM = new CharacterField(message, HEADERSIZE + 100,
				30, "SUMNNM");
		fields[9] = fieldSUMFIR = new CharacterField(message, HEADERSIZE + 130,
				1, "SUMFIR");
		fields[10] = fieldSUMCLA = new CharacterField(message,
				HEADERSIZE + 131, 18, "SUMCLA");
		fields[11] = fieldSUMODD = new DecimalField(message, HEADERSIZE + 149,
				3, 0, "SUMODD");
		fields[12] = fieldSUMODM = new DecimalField(message, HEADERSIZE + 152,
				3, 0, "SUMODM");
		fields[13] = fieldSUMODY = new DecimalField(message, HEADERSIZE + 155,
				3, 0, "SUMODY");
		fields[14] = fieldSUMMAD = new DecimalField(message, HEADERSIZE + 158,
				3, 0, "SUMMAD");
		fields[15] = fieldSUMMAM = new DecimalField(message, HEADERSIZE + 161,
				3, 0, "SUMMAM");
		fields[16] = fieldSUMMAY = new DecimalField(message, HEADERSIZE + 164,
				3, 0, "SUMMAY");
		fields[17] = fieldSUMFCP = new DecimalField(message, HEADERSIZE + 167,
				8, 4, "SUMFCP");
