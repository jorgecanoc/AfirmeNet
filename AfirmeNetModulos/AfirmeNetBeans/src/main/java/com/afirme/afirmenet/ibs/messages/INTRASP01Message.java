...
/**
 * Class generated by AS/400 CRTCLASS command from INTRASP01 physical file
 * definition.
 * 
 * File level identifier is 1121116180707. Record format level identifier is
 * 242BB7F53D8F6.
 */
@SuppressWarnings("rawtypes")
public class INTRASP01Message extends MessageRecord {
	final static String fldnames[] = { "INTUSR", "INTFRMACC", "INTTOACC",
			...
			"INTCRGLN", "INTCRACC", "INTUS1", "INTUS2", "INTUS3" };
	final static String tnames[] = { "INTUSR", "INTFRMACC", "INTTOACC",
			...
			"INTDRGLN", "INTDRACC", "INTCRBNK", "INTCRBRN", "INTCRCCY",
			"INTCRGLN", "INTCRACC", "INTUS1", "INTUS2", "INTUS3" };
	final static String fid = "1121116180707";
	final static String rid = "242BB7F53D8F6";
	final static String fmtname = "INTRASP01";
	...
	/**
	 * Constructor for INTRASP01Message.
	 */
	public INTRASP01Message() {
		createFields();
		initialize();
	}
	...
	protected void createFields() {
		...
		fields[38] = fieldINTUS1 = new CharacterField(message,
				HEADERSIZE + 399, 10, "INTUS1");
		fields[39] = fieldINTUS2 = new CharacterField(message,
				HEADERSIZE + 409, 10, "INTUS2");
		fields[40] = fieldINTUS3 = new CharacterField(message,
				HEADERSIZE + 419, 10, "INTUS3");
