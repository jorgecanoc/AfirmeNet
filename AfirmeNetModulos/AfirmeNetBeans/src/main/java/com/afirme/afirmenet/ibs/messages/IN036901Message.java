...
/**
 * Class generated by AS/400 CRTCLASS command from IN036901 physical file
 * definition.
 * 
 * File level identifier is 1030213133409. Record format level identifier is
 * 4C4E8D73D92E2.
 */
@SuppressWarnings("rawtypes")
public class IN036901Message extends MessageRecord {
	final static String fldnames[] = { "H69USERID", "H69OPECOD", "H69FLGMAS",
			"E69RATCY1", "E69RATCY2", "E69RATAMT" };
	final static String tnames[] = { "H69USERID", "H69OPECOD", "H69FLGMAS",
			"E69RATCY1", "E69RATCY2", "E69RATAMT" };
	...
	protected void createFields() {
		...
		fields[0] = fieldH69USERID = new CharacterField(message,
				HEADERSIZE + 0, 10, "H69USERID");
		fields[1] = fieldH69OPECOD = new CharacterField(message,
				HEADERSIZE + 10, 4, "H69OPECOD");
		fields[2] = fieldH69FLGMAS = new CharacterField(message,
				HEADERSIZE + 14, 1, "H69FLGMAS");
		fields[3] = fieldE69RATCY1 = new CharacterField(message,
				HEADERSIZE + 15, 3, "E69RATCY1");
		fields[4] = fieldE69RATCY2 = new CharacterField(message,
				HEADERSIZE + 18, 3, "E69RATCY2");
		fields[5] = fieldE69RATAMT = new DecimalField(message, HEADERSIZE + 21,
				17, 2, "E69RATAMT");
