      ...
      <div class="col-der relative">
       ...
       <div class="contenido">
          ...
          <div class="p20">
            ...
            <div class="clearfix">
              ...
              <div class="col11 xs-col10">
                <h3 class="titulo"><spring:message code="afirmenet.transferencias.terceros.guardadas" /></h3>
		 ...
		 <c:forEach var="error" items="${errores}">
            ...
            <ul class="guardadas">
			<c:forEach var="comprobante" items="${listComprobantes}">
            <li class="comprobante"><div>
              <div class="row mb10">
                ...
                <div class="col7">
                  ...
                  <p class="f-verdeO">${comprobante.afirmeNetReference}</p>                    
                </div>
              ...
              <div class="row ocultar">
                ...
                <div class="col3">
                  ...
                  <p class="f-verdeO">$ ${comprobante.amount}</p>                    
                </div> 
                <div class="col5">
                  <p><strong><spring:message code="afirmenet.comprobantes.concepto"/></p>
                  <p class="f-verdeO">${comprobante.description}</p>                    
                </div>                
              </div>
              <div class="detalle">
                <div class="btb mb15"><div class="row">
                  ...
                  <div class="col6">
                    ...
                    <p class="f-verdeO">${comprobante.userReference}</p>                  
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col6 xs-break">
                    ...
                    <div class="mb15">
                      ...
                      <p class="f-verdeO">${comprobante.debitAccount}</p>
                    </div>

                    <div class="mb15">
                      <p><strong><spring:message code="afirmenet.comprobantes.contrato"/></strong></p>
                      <p class="f-verdeO">${comprobante.contractId}</p>
                    </div>
                  ...
                  <div class="col6 xs-break">
                    ...
                    <div class="mb15">
                      ...
                      <p class="f-verdeO">${comprobante.creditAccount}</p>
                    </div>
                    ...
                    <c:if test="${not empty comprobante.emailBeneficiary}">
                    <div class="mb15">
                      <p><strong><spring:message code="afirmenet.comprobantes.email"/></strong></p>
                      <p class="f-verdeO">${comprobante.emailBeneficiary}</p>
                    </div>
                    </c:if>
                    ...
                    <div class="mb15">
                      ...
                      <p class="f-verdeO">
                        ...
                        <c:if test="${comprobante.validationHour gt 0}">
                        <spring:message code="afirmenet.comprobantes.hora"/> ${comprobante.validationHour}:${comprobante.validationMinute} hrs<br>
                        <spring:message code="afirmenet.comprobantes.dia"/> ${comprobante.validationDay} / ${comprobante.validationMonth} / ${comprobante.validationYear}
                        </c:if>
                      </p>
                    </div>
