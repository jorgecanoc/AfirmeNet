		...
		<div class="contenido">
			<form:form commandName="transferencia" method="POST"action="${context}/transferencias/terceros/realizarTransferencia.htm">
				...
				<div class="ovhidden mb30">
					<div class="pasos">
						<span class="paso col6 activo"><span><spring:message code="afirmenet.transferencias.paso1" />
						<small class="hide-xs"><spring:message code="afirmenet.transferencias.paso.confirmarguardadas" /></small></span></span>
						<span class="paso col6"><span><spring:message code="afirmenet.transferencias.paso2" />
						<small class="hide-xs"><spring:message code="afirmenet.transferencias.paso.comprobante" /></small></span></span>
					</div>
				</div>

				<div class="clearfix mb10">
					<h3 class="f-verdeO fL">Lista de Transferencias</h3>
					<a href="#" class="icon icon-info fR tooltip"><span><span class="icon icon-close2"></span><span class="h6">
				...
				<c:forEach var="transferencia" items="${listaTransferencias}">
					...
					<div class="row">
						<div class="col4">
							...
							<p class="f-verdeO"><spring:message code="afirmenet.transferencias.terceros.titulo" /></p>
						</div>
						<div class="col3">
						...
						<div class="col2" align="right">
							<a href="TRANSF_Nacionales-guardadas-editar.html"
								class="icon icon-t-edit"></a> <a class="icon icon-t-minus"></a>
					...
					<div class="detalle row">
						...
						<div class="col6 xs-break">
							<div class="mb20">
								...
								<p class="f-verdeO">
								${transferencia.origen.description} (${transferencia.origen.numberMask}) - 
								$${transferencia.origen.balanceFormatted} - ${transferencia.origen.ccy}
								</p>
							</div>
						</div>
						...
						<div class="mb15">
							...
							<p class="f-verdeO">
							${transferencia.destino.description} (${transferencia.destino.numberMask}) - 
							$${transferencia.destino.balanceFormatted} - ${transferencia.destino.ccy}
							</p>
						</div>
						...
						<div class="mb15">
							...
							<p class="f-verdeO">
								<spring:message code="afirmenet.comprobantes.inmediata" />
								<br>
								<spring:message code="afirmenet.comprobantes.hora" />
								${transferencia.validationHour}:${transferencia.validationMinute} hrs<br>
								<spring:message code="afirmenet.comprobantes.dia" />
								${transferencia.validationDay} / ${transferencia.validationMonth} / ${transferencia.validationYear}
							</p>
						</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col6 xs-break xs-mb20"></div>
					<div class="col6 xs-break">
						<p class="h6 mb5">&nbsp;</p>
						<div class="acciones" align="right">
						<button onclick="submitFormAnimate('transferencia','transferencias/terceros/realizarTransferencia.htm'); return false;" class="btn verde">
							<spring:message code="afirmenet.botones.aceptar" />
						</button>
						</div>
					</div>
				</div>
