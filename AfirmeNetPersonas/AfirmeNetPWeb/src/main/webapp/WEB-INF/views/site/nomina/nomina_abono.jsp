    ...
    <article>
      ...
      <div class="col-der relative">
        ...
        <div class="contenido">
          ...
          <h3 class="titulo">Abono a Capital</h3>
          ...
          <div class="mb20">
            <fieldset>
              <div class="form-label w33"><label for="clave-transfer">Número de Cuenta de Cargo</label></div>
              <div class="form-input relative">
				<form:select path="creditAccount" cssClass="drop req">
					<option value="">Seleccionar Cuenta</option>
					<c:forEach var="cuentaNomina" items="${cuentasNomina}">
					<option value="${cuentaNomina.number}">
					${cuentaNomina.description} (${cuentaNomina.number}) -
					$${cuentaNomina.balanceFormatted} - ${cuentaNomina.ccy}</option>
					</c:forEach>
				</form:select>
			  </div>
            </fieldset>
            <fieldset>
              <div class="form-label w33"><label for="clave-transfer">Crédito Autorizado</label></div>
              <div class="form-input relative">
              	$ ${nomina.montoAutorizadoFormatted}
              </div>
            </fieldset>
            <fieldset>
              <div class="form-label w33"><label for="clave-transfer">Saldo a Capital</label></div>
              <div class="form-input relative">
            ...
            <fieldset>
              <div class="form-label w33"><label for="clave-transfer">Importe del Abono a Capital</label></div>
              <div class="form-input relative">
