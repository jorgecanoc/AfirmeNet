...
@Controller
@RequestMapping("/inversiones/perfecta")
public class InversionPerfectaController  extends TransferenciaController {
	...
	public String selecciona(HttpServletRequest request, ModelMap modelMap) {
		LOG.debug("Atendiendo Peticion = /inversiones/perfecta/selecciona.htm");
	...
	public String captura(HttpServletRequest request, ModelMap modelMap) {
		LOG.debug("Atendiendo Peticion = /inversiones/perfecta/captura.htm");
	...
	public String confirma(HttpServletRequest request, ModelMap modelMap) {
		LOG.debug("Atendiendo Peticion = /inversiones/perfecta/confirma.htm");
	...
	public String comprobante(HttpServletRequest request, ModelMap modelMap) {
		LOG.debug("Atendiendo Peticion = /inversiones/perfecta/comprobante.htm");
